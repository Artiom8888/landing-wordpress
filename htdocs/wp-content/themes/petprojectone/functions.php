<?php
  ...
  function add_scripts_and_styles(){
    ...
    // wp_register_script( 'jquery', get_template_directory_uri() . "/node_modules/jquery/dist/jquery.min.js", false, null, true );
    ...
    wp_enqueue_style( 'main', get_stylesheet_uri( ), array('fontello', 'fonts', 'swiper-style') );
